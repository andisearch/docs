...
|------|-------|----------|----------|
| **High** | `--opus` / `--high` | Complex reasoning, architecture | Opus 5 |
| **Mid** | `--sonnet` / `--mid` | Balanced coding tasks | Sonnet 5 |
...
Default Provider: AWS Bedrock + Opus 5
